document.getElementsByClassName("select-all-checkbox")[0].onclick = function() {
    var checkboxes = document.getElementsByClassName("checkbox-of-item");
...
const showFilters = () => {
    document.getElementsByClassName("show-filters")[0].style.display = "none";
    document.getElementsByClassName("hide-filters")[0].style.display = "block";
    document.getElementsByClassName("filter-list")[0].style.display = "flex";

}

const hideFilters = () => {
    document.getElementsByClassName("show-filters")[0].style.display = "block";
    document.getElementsByClassName("hide-filters")[0].style.display = "none";
    document.getElementsByClassName("filter-list")[0].style.display = "none";

}

const checkForDisablingApply = (changedSelect) => {
    var value = changedSelect.value;
    console.log("value is " + value);
    if (value)
        document.getElementsByClassName("apply-button-div-all-tickets")[0].classList.remove('disabled');
    else {
        var selectList = document.getElementsByClassName("filter-sel");
        var flag = false;
        ...
        if (flag)
            ...
            document.getElementsByClassName("apply-button-div-all-tickets")[0].classList.add('disabled');
    }
